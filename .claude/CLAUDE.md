...
- you can run dev server and do live browser inspection of the ported three.js version of the game for any inspection needed including visual inspection
- the goal is to be 100% faithful between ported version and the original. The ultimate goal is to play the ported threejs version of the game and feel like as if playing the exact original game but in a browser
